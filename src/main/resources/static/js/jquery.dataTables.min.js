...
"bJUI");p(h,e,"fnCookieCallback");p(h,e,"fnStateLoad");p(h,e,"fnStateSave");p(h.oLanguage,e,"fnInfoCallback");B(h,"aoDrawCallback",e.fnDrawCallback,"manager");B(h,"aoServerParams",e.fnServerParams,"manager");B(h,"aoStateSaveParams",e.fnStateSaveParams,"manager");B(h,"aoStateLoadParams",e.fnStateLoadParams,"manager");B(h,"aoStateLoaded",e.fnStateLoaded,"manager");B(h,"aoRowCallback",e.fnRowCallback,"manager");B(h,"aoRowCreatedCallback",e.fnCreatedRow,"manager");B(h,"aoHeaderCallback",e.fnHeaderCallback,"manager");B(h,"aoFooterCallback",
e.fnFooterCallback,"manager");B(h,"aoInitComplete",e.fnInitComplete,"manager");B(h,"aoPreDrawCallback",e.fnPreDrawCallback,"manager");h.oFeatures.bServerSide&&h.oFeatures.bSort&&h.oFeatures.bSortClasses?B(h,"aoDrawCallback",Q,"server_side_sort_classes"):h.oFeatures.bDeferRender&&B(h,"aoDrawCallback",Q,"defer_sort_classes");e.bJQueryUI?(i.extend(h.oClasses,j.ext.oJUIClasses),e.sDom===j.defaults.sDom&&"lfrtip"===j.defaults.sDom&&(h.sDom='<"H"lfr>t<"F"ip>')):i.extend(h.oClasses,j.ext.oStdClasses);i(this).addClass(h.oClasses.sTable);
